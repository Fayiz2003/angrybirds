...
const more = () => {
    ...
    game.innerHTML = `
        <div class="col1 mx-2"  data-aos="fade-up"
    data-aos-duration="1000">
            <img class="g" src="./img/d1.jpeg" width="350px" height="230px" alt="">
            <h6 class="text3">STORY</h6>
            <h5 class="text-light mt-3">EPIC GAMES FEELS FASTER</h5>
            <h6 class="my-2">⭐⭐⭐⭐⭐</h6>
            <button class="but my-3"> PLAY NOW<span></span></button>
        </div>
        <div class="col1 mx-2"  data-aos="fade-up"
    data-aos-duration="1000">
            <img class="g" src="./img/d2.webp" width="350px" height="230px" alt="">
            <h6 class="text3">BLOOD</h6>
            <h5 class="text-light mt-3">EPIC GAMES FEELS FASTER</h5>
            <h6 class="mt-1">⭐⭐⭐⭐</h6>
            <button class="but my-3"> PLAY NOW<span></span></button>
        </div>
        <div class="col1 mx-2"  data-aos="fade-up"
    data-aos-duration="1000">
            <img class="g" src="./img/d3.jpg" width="350px" height="230px" alt="">
            <h6 class="text3">FAST</h6>
            <h5 class="text-light mt-3">EPIC GAMES FEELS FASTER</h5>
            <h6 class="mt-1">⭐⭐⭐⭐⭐</h6>
            <button class="but my-3"> PLAY NOW<span></span></button>
        </div>
        <div class="col1 mx-2"  data-aos="fade-up"
    data-aos-duration="1000">
            <img class="g" src="./img/d4.webp" width="350px" height="230px" alt="">
            <h6 class="text3">CARTOON</h6>
            <h5 class="text-light mt-3">EPIC GAMES FEELS FASTER</h5>
            <h6 class="mt-1">⭐⭐⭐⭐</h6>
            <button class="but my-3"> PLAY NOW<span></span></button>
        </div>
